    ...
    <nav className="bg-gradient-to-r from-[#0a0920] via-[#1a1f3c] to-[#0a0920] text-white py-4 px-6 shadow-[0_4px_30px_rgba(45,212,191,0.1)]">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          ...
          <a href="https://canary.discord.com/oauth2/authorize?client_id=1108545284264431656" 
             target="_blank"
          ...
          <button className="px-4 py-2 rounded-lg bg-gradient-to-r from-teal-400 to-cyan-400 hover:from-teal-500 hover:to-cyan-500 transition-all duration-300 ease-in-out hover:shadow-[0_0_15px_rgba(45,212,191,0.3)]">
            Login
          </button>
        </div>
      </div>
